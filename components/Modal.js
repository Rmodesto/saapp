...
const Modal = ({ open, children, onClose }) => {
  ...
  return (
    <>
      <div className="fixed top-0 right-0 left-0 bottom-0 bg-gray-300 blur-sm opacity-70 z-50" />
      <div className=" bg-white p-14 fixed top-2/4 rigt-0 left-2/4 bottom-0 z-50 flex -translate-y-2/4 -translate-x-2/4 items-center justify-center">
        <div
          id="drawer-contact"
